...
public class TorreService extends BaseService<TorreEntity> implements Serializable {
    ...
    @Transactional
    public List<TorreEntity> findAllTorreEntities() {
    ...
    public long countAllEntries() {
        return entityManager.createQuery("SELECT COUNT(o) FROM Torre o", Long.class).getSingleResult();
    }

    @Override
    protected void handleDependenciesBeforeDelete(TorreEntity tercero) {

        /* This is called before a Torre is deleted. Place here all the
...
*/
    ...
    @Transactional
    public List<TorreEntity> findAvailableTorres(TipoIdentificacionEntity tipoIdentificacion) {
        return entityManager.createQuery("SELECT o FROM Torre o WHERE o.tipoIdentificacion IS NULL", TorreEntity.class).getResultList();
    }

    @Transactional
    public List<TorreEntity> findTorresByTipoIdentificacion(TipoIdentificacionEntity tipoIdentificacion) {
        return entityManager.createQuery("SELECT o FROM Torre o WHERE o.tipoIdentificacion = :tipoIdentificacion", TorreEntity.class).setParameter("tipoIdentificacion", tipoIdentificacion).getResultList();
    }
    ...
    */
    ...
    public List<TorreEntity> findEntriesPagedAndFilteredAndSorted(int firstResult, int maxResults, String sortField, SortOrder sortOrder, Map<String, Object> filters) {
        ...
        query.append("SELECT o FROM Torre o");
        ...
        TypedQuery<TorreEntity> q = this.entityManager.createQuery(query.toString(), this.getType());
